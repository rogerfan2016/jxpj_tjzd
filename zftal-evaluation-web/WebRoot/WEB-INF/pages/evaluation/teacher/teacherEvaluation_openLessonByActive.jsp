...
<html>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        $("#btn_dc").click(function() {
          window.open("<%=request.getContextPath()%>/evaluation/teacher_exportActive.html?" + $("#search").serialize());
        });
  ...
  <div class="toolbox">
      <div class="buttonbox">
        <ul>
          <li>
            <a id="btn_dc" class="btn_dc">导出评价记录</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <table width="100%" border="0">
          <tbody>
            <tr>
              ...
              <th>状态</th>
              <td>
                <select name="tolQuery.sfpj" style="width:70px;">
                  <option value=""></option>
          ...
          <table width="100%" class="dateline tablenowrap">
            ...
            <tbody id="list_body">
              ...
              <tr name="tr">
                  ...
                  <c:if test="${info.pjqk eq '1' }"><a style="color:#074695" href="#" onclick="doEvaluation('${info.pjid}');">查看评价</a></c:if>
                </td>
              	<td>
